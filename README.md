...
1. tj-24 上启动 topo-server：`bash deploy/tj/start.sh`
2. 本机 SSH 隧道：`ssh -L 4000:177.177.190.145:4000 tj-24`
3. 本机启动 [cytoscape-express](https://github.com/theFly6/cytoscape-express)：`SERVER_URL_BASE=127.0.0.1:4000`，`NEO4J_ENABLED=false`
4. 本仓 `npm run dev`
